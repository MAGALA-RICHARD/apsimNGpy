...
Package entry point.
======================================================================
This module intentionally avoids initializing or resolving binary paths.
Doing so ensures that configuration and settings utilities remain accessible
in the event of binary resolution errors or partial installations.
"""
...
__all__ = ['auto_detect_apsim_bin_path', 'apsim_bin_context', '__version__',
...
if not Path(CURRENT_BIN).exists():
    logger.warning('APSIM bin path does not exist or not set yet')

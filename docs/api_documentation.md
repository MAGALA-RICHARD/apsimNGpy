...
```python
format_type(annotation: unknown)
...
```python
extract_docstrings(file_path: unknown)
...
## Function: extract_docstrings_recursive

```python
extract_docstrings_recursive(directory: unknown)
...
```python
main(title: unknown, in_dir: unknown, out: unknown)

Main function to extract docstrings from all Python files and save the documentation to a markdown file.

Args:
    title (str): Title for the generated markdown documentation.
    in_dir (str): The directory to scan for Python files.
    out (str): Output path to save the markdown documentation.
```
...
## Function: daymet_bylocation_nocsv
...
```python
adjust_dul(self: unknown, simulations: unknown)
...
## Function: get_unique_soil_series
...
```python
replace_downloaded_soils(self: unknown, soil_tables: unknown, simulation_names: unknown)
...
## Function: relace_initial_carbon
...
```python
spin_up(self: unknown, report_name: str, start: unknown, end: unknown, spin_var: unknown, simulations: unknown)
...
```python
load_default_simulations(crop: str, path: unknown, simulations_object: bool)
...
```python
run_simulations(self: unknown, results: bool, reports: Union[tuple, list], clean_up: bool)
...
```python
simulation_object(self: unknown, value: unknown)
...
## Function: simulation_names

```python
simulation_names(self: unknown)
...
```python
restart_model(self: unknown, model_info: unknown)
...
```python
save_edited_file(self: unknown, out_path: unknown, reload: unknown)
...
```python
run(self: unknown, report_name: Union[tuple, list], simulations: Union[tuple, list], clean: bool, multithread: bool, verbose: bool, get_dict: bool, init_only: bool)
...
## Function: remove_simulation

```python
remove_simulation(self: unknown, simulation: Union[tuple, list])
...
```python
clone_zone(self: unknown, target: str, zone: str, simulation: Union[tuple, list])
...
```python
find_zones(self: unknown, simulation: Union[tuple, list])
...
```python
replicate_file(self: unknown, k: int, path: unknown, tag: str)
...
```python
_cultivar_params(self: unknown, cultivar: str)
...
```python
get_current_cultivar_name(self: unknown, ManagerName: str)
...
## Function: collect_specific_report
...
```python
examine_management_info(self: unknown, simulations: Union[list, tuple])
...
```python
recompile_edited_model(self: unknown, out_path: unknown)
...
```python
preview_simulation(self: unknown)
...
```python
extract_user_input(self: unknown, manager_name: str)
...
```python
change_simulation_dates(self: unknown, start_date: str, end_date: str, simulations: Union[tuple, list])
...
```python
extract_start_end_years(self: unknown, simulations: str)
...
```python
show_met_file_in_simulation(self: unknown, simulations: list)
...
```python
extract_soil_physical(self: unknown, simulations: unknown)
...
```python
extract_any_soil_physical(self: unknown, parameter: unknown, simulations: unknown)
...
## Function: replace_any_soil_physical

```python
replace_any_soil_physical(self: unknown)
...
## Function: extract_soil_organic

```python
extract_soil_organic(self: unknown, simulation: tuple)
...
## Function: replace_any_solute

```python
replace_any_solute(self: unknown)
...
```python
replace_soil_properties_by_path(self: unknown, path: str, param_values: list, str_fmt: unknown)
...
```python
replace_soil_property_values(self: unknown)
...
```python
extract_any_soil_organic(self: unknown, parameter: str, simulation: tuple)
...
```python
extract_crop_soil_water(self: unknown, parameter: str, crop: str, simulation: Union[list, tuple])
...
```python
find_simulations(self: unknown, simulations: Union[list, tuple])
...
```python
set_swcon(self: unknown, swcon: list, simulations: Union[list, tuple], thickness_values: list)
...
## Function: replace_soil_organic

```python
replace_soil_organic(self: unknown)
...
## Function: decreasing_exponential_function
...
```python
add_factor(self: unknown, factor_type: unknown)
...
```python
test_experiment(self: unknown, test_size: int)
...
```python
clear_data_base(self: unknown, all_tables: unknown, report_name: unknown)
...
```python
__init__(self: unknown, options: unknown, place_holder_name: unknown)
...
```python
sigma(self: unknown, value: unknown)
...
```python
mean(self: unknown, value: unknown)
...
```python
options(self: unknown, values: unknown)
...
```python
path(self: unknown, name: unknown)
...
```python
__init__(self: unknown, sdf: unknown, thickness: unknown, thickness_values: unknown, bottomdepth: unknown, state: unknown)
...
## Function: get_met_from_day_met

```python
get_met_from_day_met(lonlat: Union[tuple, list, numpy.ndarray], start: int, end: int, filename: str, fill_method: str, retry_number: Union[int, unknown])
...
```python
write_edited_met(old: Union[str, Path], daf: pd.DataFrame, filename: str)
...
```python
custom_parallel(func: unknown, iterable: unknown)
...
```python
run_apsimx_files_in_parallel(iterable_files: unknown)
...
```python
read_result_in_parallel(iterable_files: unknown, ncores: unknown, use_threads: unknown, report_name: unknown)
...
```python
download_soil_tables(iterable: unknown, use_threads: unknown, ncores: unknown)
...
```python
update_mgt_by_path(self: unknown)
...
## Function: update_children_params

```python
update_children_params(self: unknown, children: tuple)
...
## Function: replace_cultivar_params

```python
replace_cultivar_params(self: unknown)
...
```python
NSE(self: unknown, params: unknown)
...
```python
__init__(self: unknown, simulator_func: unknown, params: unknown, observed: unknown)
...
```python
loss_function(self: unknown, _loss_function: unknown)
...
```python
run_glue(self: unknown, threshold: unknown, direction: unknown, parallel: unknown)
...
```python
coverage(self: unknown, ci_data: unknown)

Prints coverage from GLUE analysis.
        
```

## Function: visualize_estimates
...
```python
__init__(self: unknown, value: unknown, comparison_direction: unknown)
...
```python
compare(self: unknown, other: unknown)
...
```python
__init__(self: unknown, name: unknown, log_file: unknown, console_level: unknown, file_level: unknown)
...
```python
__call__(self: unknown, level: unknown, message: unknown)
...
## Function: delete_simulation_files
...
## Function: organize_crop_rotations
...
```python
RRMSE(self: unknown, actual: unknown, predicted: unknown)
...
```python
WIA(self: unknown, obs: unknown, pred: unknown)
...
```python
MSE(self: unknown, actual: unknown, predicted: unknown)
...
```python
mva(self: unknown, data: unknown, window: unknown)
...
```python
ME(self: unknown, actual: unknown, predicted: unknown)
...
```python
__init__(self: unknown, actual: unknown, predicted: unknown)
...
```python
evaluate(self: unknown, metric: str)
...
```python
evaluate_all(self: unknown, verbose: bool)
...
```python
get_theils_u_for_df(df: pd.DataFrame)
...
```python
_apsim_model_is_installed(_path: unknown)
...
## Function: _init_from_simulations

```python
_init_from_simulations(self: unknown, model: Simulations)

Initialize the object from a Simulations object.
```

## Function: load_apsimx_model

```python
load_apsimx_model(self: unknown, from_file: unknown)
...
```python
save_edited_file(self: unknown, outpath: unknown, reload: unknown)
...
```python
run(self: unknown, report_name: unknown, simulations: unknown, clean: unknown, multithread: unknown)
...
## Function: extract_simulation_name
...
## Function: read_apsimx_db

```python
read_apsimx_db(datastore: unknown, report_name: unknown)
...
```python
replicate_file(self: unknown, k: unknown, path: unknown, tag: unknown)
...
## Function: _read_external_simulation
...
```python
edit_cultivar(self: unknown, CultivarName: unknown, commands: tuple, values: tuple)
...
## Function: update_manager_parameters

```python
update_manager_parameters(self: unknown)
...
## Function: collect_specificreport
...
## Function: update_management_decissions

```python
update_management_decissions(self: unknown, management: unknown, simulations: unknown, out: unknown)
...
```python
update_mgt(self: unknown, management: unknown, simulations: unknown, reload: unknown, out: unknown)
...
## Function: replace_any_soil_organic
...
## Function: replace_crop_soil_water
...
```python
set_swcon(self: unknown, swcon: unknown, simulations: unknown, thickness_values: unknown)
...
## Function: _get_maize_NF_experiment
...
## Function: load_in_memory

```python
load_in_memory(out: unknown, met_file: unknown)
...
## Function: get_maize_with_cover_crop
...
## Function: get_experiment_nitrogen_residue
...
## Function: get_get_experiment_nitrogen_residue_NT
...
## Function: get_maize_model_no_till
...
```python
run_simulations(self: unknown, results: unknown, reports: unknown, clean_up: unknown)
...
```python
run(self: unknown, report_name: unknown, simulations: unknown, clean: unknown, multithread: unknown, verbose: unknown, get_dict: unknown, init_only: unknown)

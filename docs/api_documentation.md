...
```
adjust_dul(self: unknown, simulations: Union[tuple, list])
...
```
replace_downloaded_soils(self: unknown, soil_tables: Union[dict, list], simulation_names: Union[tuple, list])
...
```
_change_met_file(self: unknown, lonlatmet: tuple, simulation_names: Union[tuple, list])
...
```
run_edited_file(self: unknown, simulations: Union[tuple, list], clean: bool, multithread: unknown)
...
```
replace_soil_properties_by_path(self: unknown, path: str, param_values: list, str_fmt: str)

...
.. function:: pl_save_todb(datas: tuple, database: str, if_exists: str)
...
.. function:: get_met_nasa_power(lonlat, start=1990, end=2000, fname='get_met_nasa_power.met')

   No documentation available.

.. function:: get_weather(lonlat: Union[tuple, list], start: int = 1990, end: int = 2020, source: str = 'daymet', filename: str = '__met_.met')
...
.. function:: get_iem_by_station(dates_tuple, station, path, met_tag)
...
.. function:: get_met_from_day_met(lonlat: Union[tuple, list, numpy.ndarray], start: int, end: int, filename: str, fill_method: str = 'ffill', retry_number: Optional[int] = 1, **kwa: None) -> str
...
.. function:: add_db_table(self, variable_spec: list = None, set_event_names: list = None, rename: str = 'my_table', simulation_name: Union[str, list, tuple] = None)
...
.. function:: add_factor(self, specification: str, factor_name: str = None, **kwargs)
...
.. function:: add_report_variable(self, variable_spec: Union[list, str, tuple], report_name: str = None, set_event_names: Union[str, list] = None)
...
.. function:: auto_gen_thickness_layers(self, max_depth, n_layers=10, thin_layers=3, thin_thickness=100, growth_type='linear', thick_growth_rate=1.5)
...
.. function:: change_simulation_dates(self, start_date: str = None, end_date: str = None, simulations: Union[tuple, list] = None)
...
.. function:: change_som(self, *, simulations: Union[tuple, list] = None, inrm: int = None, icnr: int = None, surface_om_name='SurfaceOrganicMatter', **kwargs)
...
.. function:: clean_up(self, db=True, verbose=False)
...
.. function:: edit_cultivar(self, *, CultivarName: str, commands: str, values: Any, **kwargs)
...
.. function:: examine_management_info(self, simulations: Union[list, tuple] = None)
...
.. function:: extract_any_soil_organic(self, parameter: str, simulation: tuple = None)
...
.. function:: extract_any_soil_physical(self, parameter, simulations: [<class 'list'>, <class 'tuple'>] = None)
...
.. function:: extract_crop_soil_water(self, parameter: str, crop: str = 'Maize', simulation: Union[list, tuple] = None)
...
.. function:: extract_soil_physical(self, simulations: [<class 'tuple'>, <class 'list'>] = None)
...
.. function:: extract_soil_property_by_path(self, path: str, str_fmt='.', index: list = None)
...
.. function:: extract_start_end_years(self, simulations: str = None)
...
.. function:: extract_user_input(self, manager_name: str)
...
.. function:: find_model(model_name: str, model_namespace=None)
...
.. function:: get_current_cultivar_name(self, ManagerName: str)
...
.. function:: get_initial_no3(self, simulation=None)

   Get soil initial NO3 content

.. function:: get_model_paths(self, cultivar=False) -> list[str]
...
.. function:: inspect_file(self, cultivar=False, **kwargs)
...
.. function:: inspect_model(self, model_type: Union[str, <module 'Models'>], fullpath=True, **kwargs)
...
.. function:: inspect_model_parameters(self, model_type, simulations, model_name)
...
.. function:: move_model(self, model_type: <module 'Models'>, new_parent_type: <module 'Models'>, model_name: str = None, new_parent_name: str = None, verbose: bool = False, simulations: Union[str, list] = None)
...
.. function:: preview_simulation(self)
...
.. function:: read_from_db_names(self, report_names: Union[str, list], **kwargs) -> pandas.core.frame.DataFrame
...
.. function:: remove_model(self, model_type: <module 'Models'>, model_name: str = None)
...
.. function:: rename_model(self, model_type: <module 'Models'>, old_model_name: str, new_model_name: str, simulations=None)
...
.. function:: replace_downloaded_soils(self, soil_tables: Union[dict, list], simulation_names: Union[tuple, list], **kwargs)
...
.. function:: replace_model_from(self, model, model_type: str, model_name: str = None, target_model_name: str = None, simulations: str = None)
...
.. function:: replicate_file(self, k: int, path: os.PathLike = None, suffix: str = 'replica')
...
.. function:: run(self, report_name: Union[tuple, list, str] = None, simulations: Union[tuple, list] = None, clean_up: bool = False, verbose: bool = False, **kwargs) -> 'CoreModel'
...
.. function:: run_edited_file(self, table_name=None)

   :param table_name (str): repot table name in the database

.. function:: save(self, file_name=None)
...
.. function:: save_edited_file(self, out_path: os.PathLike = None, reload: bool = False) -> Optional[ForwardRef('CoreModel')]
...
.. function:: set_categorical_factor(self, factor_path: str, categories: Union[list, tuple], factor_name: str = None)
...
.. function:: set_continuous_factor(self, factor_path, lower_bound, upper_bound, interval, factor_name=None)
...
.. function:: spin_up(self, report_name: str = 'Report', start=None, end=None, spin_var='Carbon', simulations=None)
...
.. function:: update_mgt(self, *, management: Union[dict, tuple], simulations: [<class 'list'>, <class 'tuple'>] = None, out: [<class 'pathlib.Path'>, <class 'str'>] = None, reload: bool = True, **kwargs)
...
.. function:: update_mgt_by_path(self, *, path: str, fmt='.', **kwargs)
